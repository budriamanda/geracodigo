...
const SLUG = 'gerador-de-codigo-de-barras'
...
export default async function BarcodePage() {
  ...
  const adPrefix = tool.adSlotPrefix || 'barcode'
  const sections = (tool.secoesConteudo || []) as unknown as ContentSection[]

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <ToolEngagementTracker toolName="barcode_generator" />
      ...
      <div className="mb-8">
        ...
        {tool.privacyBadgeText && (
          <p className="text-sm text-indigo-600 mt-1">{tool.privacyBadgeText}</p>
        )}
